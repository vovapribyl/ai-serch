...
| Автор | Codex |
| Нормативные входы | [ART-00](00-source-and-decision-register.md) v1.1, `APPROVED_BY_OWNER`; [ART-01](01-vision-and-scope.md) v0.6, `APPROVED_BY_OWNER`; [ART-02](02-stakeholders-and-glossary.md) v0.3, `APPROVED_BY_OWNER` |
...
| Поставщик | Может передать сведения или фотографию товара; это создаёт обратный сценарий проверки ранее рассмотренного товара | `SRC-001`, фрагмент о поставщике и товаре другого цвета | Каналы и частота взаимодействия; поставщик не описан как пользователь текущей таблицы |
| Лицо, принимающее итоговое решение | `UNKNOWN`: доступные источники не называют должность, полномочия и связь с группой «другие сотрудники» | `GAP-002`; ограничения `SRC-001` | Нельзя приравнять любого просматривающего сотрудника к ЛПР по товару |
...
## 5. Обратный сценарий: предложение от поставщика

| Позиция участника или неизвестное | Основание | Ограничение |
|---|---|---|
| Товар может поступить на проверку от поставщика как фотография или сведения о позиции, в том числе как другой цвет товара | `SRC-001`, фрагмент о поставщике и «голубеньком» товаре | Не установлены форматы, обязательные данные, каналы и частота такого поступления |
| В этом случае участнику важна возможность проверить, рассматривалась ли позиция ранее и по какой причине была отвергнута | `SRC-001`, фрагмент о проверке прежнего рассмотрения и причине отказа | Наличие, полнота, место хранения и доступность причины отказа в текущем инструменте не доказаны |
| Обратный сценарий может происходить «не с табличкой» | `SRC-001`, соответствующая оговорка участника | Неизвестно, какой инструмент или действие используется вместо таблицы и при каких условиях |
| `UNKNOWN`: способ поиска истории, сопоставление товара другого цвета и фиксация результата не установлены | `SRC-001`; `GAP-003`, `GAP-004`, `GAP-005` | Нельзя выводить правило сопоставления, классификацию варианта или механизм поиска |
...
|---|---|---|
| `GAP-002`: официальные роли и полномочия | Нельзя построить подтверждённую матрицу ответственности или назвать ЛПР AS-IS | Уточнение владельца и дальнейшая работа со стейкхолдерами |
